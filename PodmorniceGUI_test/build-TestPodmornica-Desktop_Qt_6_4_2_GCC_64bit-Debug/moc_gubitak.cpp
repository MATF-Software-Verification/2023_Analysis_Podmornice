...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Gubitak_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Gubitak_t qt_meta_stringdata_Gubitak = {
    {
        QT_MOC_LITERAL(0, 7)   // "Gubitak"
    },
    "Gubitak"
};
...
Q_CONSTINIT static const uint qt_meta_data_Gubitak[] = {
...
Q_CONSTINIT const QMetaObject Gubitak::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_Gubitak.offsetsAndSizes,
    qt_meta_data_Gubitak,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Gubitak_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Gubitak, std::true_type>
    >,
    nullptr
} };
